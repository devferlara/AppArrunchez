...
/**
 * Entity mapped to table "CALIMENTOS".
 */
public class Calimentos {
    ...
    private transient CalimentosDao myDao;

    private Calificaciones calificaciones;
    private Long calificaciones__resolvedKey;

    private Alimentos alimentos;
    private Long alimentos__resolvedKey;


    public Calimentos() {
    }

    public Calimentos(Long id) {
        this.id = id;
    }

    public Calimentos(Long id, Boolean estado, long calificacion_id, long alimento_id) {
        this.id = id;
        this.estado = estado;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getCalimentosDao() : null;
    }
    ...
    public Alimentos getAlimentos() {
        ...
        if (alimentos__resolvedKey == null || !alimentos__resolvedKey.equals(__key)) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            AlimentosDao targetDao = daoSession.getAlimentosDao();
            Alimentos alimentosNew = targetDao.load(__key);
            synchronized (this) {
                alimentos = alimentosNew;
            	alimentos__resolvedKey = __key;
            }
        }
        return alimentos;
    }
    ...
    public void setAlimentos(Alimentos alimentos) {
        ...
        synchronized (this) {
            ...
            alimento_id = alimentos.getId();
            alimentos__resolvedKey = alimento_id;
        }
    }
