        ...
        t = new TimePickerDialog.OnTimeSetListener() {
            public void onTimeSet(TimePicker timePicker, int h, int m) {
                if (timePicker.isShown()) {
                    ...
                    AlertDialog.Builder sayWindows = new AlertDialog.Builder(getActivity());
                        ...
                        public void onShow(DialogInterface dialog) {
                            ...
                            b.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    if(nombres.getText().length() != 0 && direccion.getText().length() != 0){
                                        ...
                                        if (calId != -1) {
                                            ...
                                            imm.hideSoftInputFromWindow(nombres.getWindowToken(), 0);
                                            imm.hideSoftInputFromWindow(direccion.getWindowToken(), 0);
                                            imm.hideSoftInputFromWindow(comentarios.getWindowToken(), 0);
